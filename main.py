...
print("")
NAME = input("Enter the file name (e.g. Eastfork) -> ")
print("")
meter = input("Enter buffer distance [m] (e.g. -2 to buffer DEM boundary in by 2 meters) -> ")
print("")
run_number = input("How many runs do you want for this channel type (1 run per unique discharge)?  -> ")
